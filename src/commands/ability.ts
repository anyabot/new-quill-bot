...
export class AbilityCommand extends Command {
  ...
  public override registerApplicationCommands(registry: Command.Registry) {
    ...
    builder.setName('ability').setDescription('Search unit\'s abilities').addStringOption(option =>
      option.setName('unit')
      ...
      var check = false;
        ...
        if (ability_name) {
          ...
          if (img) {
              ...
              embed.setURL(link)
              embed.addFields({
                name: ability_name, value: des
              })
              if (note) embed.addFields({
        ...
        if (aw_ability_name) {
          ...
          if (aw_img) {
              ...
              embed.setURL(link)
              embed.addFields({
                name: aw_ability_name, value: des
              })
              if (note) embed.addFields({
                name: "Notes", value: note
              })
